  ...
  <div class="min-h-screen bg-gray-50">
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        <UiCard class="cursor-pointer hover:shadow-lg transition-shadow" @click="navigateTo('/invoice-box')">
          <div class="flex items-center justify-between">
            <div class="flex items-center">
              ...
              <div class="ml-4">
                <h3 class="text-lg font-semibold text-gray-900">发票收集箱</h3>
                <p class="text-sm text-gray-600">管理和整理您的发票</p>
              </div>
            </div>
        ...
        <UiCard class="cursor-pointer hover:shadow-lg transition-shadow" @click="navigateTo('/reimbursements')">
          <div class="flex items-center justify-between">
            <div class="flex items-center">
              ...
              <div class="ml-4">
                <h3 class="text-lg font-semibold text-gray-900">报销单管理</h3>
                <p class="text-sm text-gray-600">查看和管理所有报销单</p>
              </div>
            </div>
            <svg class="w-6 h-6 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
